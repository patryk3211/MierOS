...
namespace kernel {
    struct fs_function_table {
        ...
        ValueOrError<VNode*> (*get_file)(u16_t minor, VNode* root, const char* path);
        ValueOrError<std::List<VNode*>> (*get_files)(u16_t minor, VNode* root, const char* path);
        ...
        ValueOrError<size_t> (*write)(u16_t minor, FileStream* filestream, void* buffer, size_t length);
